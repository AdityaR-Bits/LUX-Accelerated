...
class Compiler:
    ...
    def populate_data_type_model(ldf, vlist):
        ...
        data_model_lookup = EX.Executor().compute_data_model_lookup(ldf.data_type)#lux.config.executor.compute_data_model_lookup(ldf.data_type)
        for vis in vlist:
    ...
    def populate_wildcard_options(_inferred_intent: List[Clause], ldf: LuxDataFrame) -> dict:
        ...
        inverted_data_type = EX.Executor().invert_data_type(ldf.data_type)#lux.config.executor.invert_data_type(ldf.data_type)
        data_model = EX.Executor().compute_data_model(ldf.data_type)#lux.config.executor.compute_data_model(ldf.data_type)
